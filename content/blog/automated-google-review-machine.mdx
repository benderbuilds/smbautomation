...
If your review system is running but your existing database has hundreds of customers who haven't booked in 6–18 months, the [dormant customer win-back guide](/blog/dormant-customer-reactivation-automation) covers the automated 4-touch reactivation sequence that recovers 8–15% of lapsed contacts — turning your CRM into a revenue channel without new ad spend. If reviews are strong and you want to compound that goodwill into new customer acquisition, the [automated referral program guide](/blog/referral-program-automation) covers the post-job sequence that turns every completed job into a trackable referral — 83% of satisfied customers will refer your business when asked at the right moment.

For businesses that also want to turn every completed job into a Google Business Profile activity event — posts, photo uploads, and automated review responses — the [Google Business Profile automation guide](/blog/google-business-profile-automation) covers how to build that layer on top of your review collection system.
