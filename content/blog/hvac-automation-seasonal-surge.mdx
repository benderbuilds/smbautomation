...
3. **Post-job follow-up fires automatically.** Review request sends within 2 hours of job completion. If no maintenance agreement is on file, the cross-sell message goes out same day. For businesses not yet capturing routine maintenance bookings outside business hours, the [online self-booking guide](/blog/online-booking-automation-service-business) covers the system that fills your schedule overnight — 40% of service appointments book after hours, and every one that hits a "call us to schedule" wall goes to a competitor.
...
The [seasonal marketing automation guide](/blog/seasonal-marketing-automation-service-business) covers the database campaign approach that fills shoulder-season capacity before surge demand peaks — the upstream complement to the surge capture system here. Roofing contractors face the same structural challenge with storm-season call spikes; the [roofing contractor automation playbook](/blog/roofing-contractor-automation-playbook) applies the same stack to storm lead capture, inspection booking, and maintenance agreement revenue. For the comprehensive maintenance agreement automation system — including conversion sequences, renewal workflows, and lapsed account recovery — see the [maintenance agreement automation guide](/blog/maintenance-agreement-automation).
