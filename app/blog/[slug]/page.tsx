...
const POST_STYLE = `
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  :root {
    ...
    --clay: #E8DDD0; --warm-white: #FFFDF9; --charcoal-dark: #1E1A16;
  }
  ...
  .post-tag { font-size: 0.7rem; font-weight: 700; letter-spacing: 0.1em; text-transform: uppercase; color: var(--copper); margin-bottom: 1rem; display: block; }
  .post-title { font-family: 'Fraunces', serif; font-size: clamp(1.8rem, 4vw, 2.6rem); font-weight: 400; line-height: 1.15; letter-spacing: -0.02em; color: var(--charcoal); margin-bottom: 1rem; }
  ...
  .post-body h2 { font-family: 'Fraunces', serif; font-size: 1.6rem; font-weight: 400; margin: 2.5rem 0 1rem; line-height: 1.25; }
  .post-body h3 { font-family: 'Fraunces', serif; font-size: 1.25rem; font-weight: 500; margin: 2rem 0 0.75rem; }
  ...
  .post-body blockquote { border-left: 3px solid var(--copper); padding-left: 1.25rem; margin: 1.5rem 0; color: var(--warm-gray); font-style: italic; }
  .cta-box { background: var(--charcoal); border-radius: 20px; padding: 2.5rem; margin-top: 4rem; text-align: center; }
  .cta-box h3 { font-family: 'Fraunces', serif; font-size: 1.5rem; font-weight: 400; color: white; margin-bottom: 0.75rem; }
  .cta-box p { color: rgba(255,255,255,0.6); font-size: 0.95rem; margin-bottom: 1.5rem; line-height: 1.6; }
  .btn-primary { background: var(--copper); color: white; padding: 0.75rem 2rem; border-radius: 100px; font-size: 0.9rem; font-weight: 600; display: inline-block; transition: all 0.2s ease; }
