      ...
      <section className="section section-white" id="how-it-works">
        <div className="inner">
          ...
          <div className="steps-grid">
            {[
              { n: "01", t: "Discover & Diagnose", sub: "Understand first, automate second.", items: ["We spend the first call learning where your business leaks time and revenue — not pitching software.", "We document your workflows end to end: what's manual, what's repeated, what's falling through the cracks.", "We rank every opportunity by dollar impact and tell you exactly what to automate first — and what to leave alone."] },
              { n: "02", t: "Design, Build & Validate", sub: "Custom solutions, tested before launch.", items: ["We build from scratch around your specific tools, your data, and the way your business actually runs.", "Every workflow gets tested on real inputs before it touches your live operation.", "We walk you through what we built and why. You own it completely — credentials, logic, documentation."] },
              { n: "03", t: "Launch, Monitor & Optimize", sub: "Continuous improvement, not a one-off project.", items: ["We go live with safeguards and clear metrics so you know from day one whether it's working.", "We watch for failures and edge cases, and fix them fast when they come up.", "Every month we review performance, tighten the logic, and push improvements. It gets better as your business grows."] },
            ].map((s, i) => (
